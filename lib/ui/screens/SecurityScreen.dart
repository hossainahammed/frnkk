  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Security", style: TextStyle(color: Colors.white, fontSize: 22.sp, fontWeight: FontWeight.w600)),
      ),
      body: Container(
        width: 1.sw,
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text("Change Password", style: TextStyle(color: Colors.white, fontSize: 16.sp, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
